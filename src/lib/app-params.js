...
const getStorageKey = (name) => `transportation_finder_${name}`;
...
const getAppParams = () => {
	...
	return {
		appId: getAppParamValue('app_id', { defaultValue: import.meta.env.VITE_APP_ID || 'transportation-finder' }),
		token: getAppParamValue('access_token', { removeFromUrl: true }) || storage.getItem('token'),
